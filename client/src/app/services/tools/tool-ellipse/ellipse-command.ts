    ...
    setWidth(width: number): void {
        ...
        if (this.ellipse) {
            this.renderer.setAttribute(
                this.ellipse,
                "width",
                this.ellipseAttributes.width.toString() + "px"
            );
            this.renderer.setAttribute(
                this.ellipse,
                "rx",
                (this.ellipseAttributes.width / 2).toString() + "px"
            );
        }
    }
    ...
    setHeight(height: number): void {
        ...
        if (this.ellipse) {
            ...
            this.renderer.setAttribute(
                this.ellipse,
                "ry",
                (this.ellipseAttributes.height / 2).toString() + "px"
            );
        }
    }
    ...
    setCX(cx: number): void {
        ...
        if (this.ellipse) {
            this.renderer.setAttribute(
                this.ellipse,
                "cx",
                this.ellipseAttributes.x.toString() + "px"
            );
        }
    }
    ...
    setCY(cy: number): void {
        ...
        if (this.ellipse) {
            this.renderer.setAttribute(
                this.ellipse,
                "cy",
                this.ellipseAttributes.y.toString() + "px"
            );
        }
    }
    ...
    execute(): void {
        if (!this.ellipse) {
            ...
            this.renderer.setStyle(
                this.ellipse,
                "stroke-width",
                this.ellipseAttributes.strokeWidth.toString() + "px"
            );
            this.renderer.setStyle(this.ellipse, "fill", this.ellipseAttributes.fill);
            this.renderer.setStyle(
                this.ellipse,
                "stroke",
                this.ellipseAttributes.stroke
            );
            this.renderer.setStyle(
                this.ellipse,
                "fillOpacity",
                this.ellipseAttributes.fillOpacity.toString()
            );
            this.renderer.setStyle(
                this.ellipse,
                "strokeOpacity",
                this.ellipseAttributes.strokeOpacity.toString()
            );
        }
