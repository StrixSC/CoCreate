...
export class Server {
    ...
    constructor(
        ...
        @inject(Types.MongoDbConnectionService) private mongoDbConnectionService: MongoDbConnectionService) {
    }
    ...
    init(): void {
        ...
        this.mongoDbConnectionService.openConnectionWithMongoServer();
